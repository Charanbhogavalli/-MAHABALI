...
export const PauseModal: React.FC<PauseModalProps> = ({
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-xs p-5 select-none animate-fadeIn overflow-y-auto">
      <div className="w-full max-w-xs max-h-[calc(100dvh-2.5rem)] overflow-y-auto p-6 rounded-2xl bg-[#1c0d05] border border-[#b45309]/60 shadow-2xl flex flex-col items-center text-center space-y-4">
        <div>
